...
internal static class Prerenderer
{
	...
	internal static Task<PrerendererResult> RenderToString(
	...
	/// <returns></returns>
	public static Task<PrerendererResult> RenderToString(
		string applicationBasePath,
		INodeService nodeServices,
		CancellationToken applicationStoppingToken,
		JavaScriptModuleExport bootModule,
	...
	{
		return nodeServices.InvokeExportAsync<PrerendererResult>(
