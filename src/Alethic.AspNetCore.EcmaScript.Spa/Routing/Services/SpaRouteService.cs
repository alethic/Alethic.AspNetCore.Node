...
public interface ISpaRouteService
{
	...
	/// <summary>Correctly sets up a redirect when used from the <see cref="Alethic.AspNetCore.EcmaScript.SpaServices.Prerendering.Services.ISpaPrerenderingService"/></summary>
	/// <param name="context"><see cref="HttpContext"/> from the <see cref="Alethic.AspNetCore.EcmaScript.SpaServices.Prerendering.Services.ISpaPrerenderingService.OnSupplyData(HttpContext, IDictionary{string, object})"/></param>
