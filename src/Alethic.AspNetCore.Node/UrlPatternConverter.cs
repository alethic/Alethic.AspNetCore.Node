...
/// </summary>
/// <remarks>
/// A route provider normalizes its framework's route syntax to URLPattern — the WHATWG standard
/// every framework's grammar lowers to mechanically — and this is the one place the host-specific
/// half of the conversion happens, so no provider learns ASP.NET's syntax and the "can a template
/// express this?" question is answered once. Only the subset ASP.NET templates can express converts:
